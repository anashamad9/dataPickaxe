...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>
      DataPickaxe | داتابيكاكس
    </title>
    <link
      rel="shortcut icon"
      href="assets\images\logo\bar_icon.png"
      type="image/x-icon"
    />
        ...
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-60 max-w-full px-4">
            <a href="index.html" class="navbar-logo block w-full py-5">
              <img
                src="assets/images/logo/LOHO_1-removebg-preview.png"
                alt="logo"
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                Improve your business with a prediction platform
              </h1>
              <p
                class="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed"
              >
                Turn your raw data into graphs and informed decisions that help you improve the work of your Enterprises.
              </p>
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mt-16">
                <img
                  src="assets/images/hero/dashboard-11.jpg"
                  alt="hero"
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mb-12 max-w-[620px] lg:mb-20">
              ...
              >
              We provide an online platform in saas format that suits your business.
              </p>
            </div>
          </div>
        </div>
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Experience the power of AI with our predictive modeling services for data              </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            >
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Transform your data into valuable insights with our data analysis services              </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Gain valuable insights and expert advice from your data with our decision support services              </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            >
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                We provide graphing services for your data              </p>
            ...
            <div class="w-full px-4">
              ...
              >
                ...
                >
                  ...
                  >
                  Improve your business with a prediction platform                  </h2>
                  <p class="mb-9 text-base leading-relaxed text-body-color">
                    DataPickaxe a B2B startup that provides technical solutions by building an aggregate model that analyzes and forecasts data to help organizations improve profitability
                  </p>
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
              ...
              >
              Our Pricing Plan And Products              </h2>
              <p
                class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
                Soon
          ...
          <div class="w-full px-4 lg:w-1/2">
              ...
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    How can the platform help my My business?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Our platform utilizes AI technology to provide accurate sales predictions and insights for
                  your business. By using our platform, you can make data-driven
                  decisions, optimize inventory, and maximize your revenue potential.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    How does DataPickaxe AI model generate sales predictions?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Our AI model analyzes a variety of factors such as historical sales data,
                  seasonality, trends, and external factors like weather or events to generate accurate
                  sales predictions. It constantly learns and adapts to provide the
                  most accurate forecasts for your business.
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Yes, our platform is designed to seamlessly integrate with
                  popular point-of-sale (POS) systems, inventory management tools,
                  and other software solutions commonly used in the retail and hospitality
                    industry. This allows for easy data synchronization and a hassle-free user experience.
...
Q4: How user-frien
          ...
          <div class="w-full px-4 lg:w-1/2">
            ...
            >
              ...
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Our platform is built with a user-friendly interface, making it easy for restaurant owners, store managers,
                  and sales professionals to navigate and understand. No technical expertise
                  is required to access and interpret the valuable insights provided by our AI model.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    Are the sales predictions provided by your platform reliable?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  es, our AI model has been trained on vast amounts of historical data and
                  validated against real-world scenarios. While we cannot guarantee 100% accuracy,
                  our platform consistently delivers reliable predictions, helping businesses
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    Can I customize the reports and graphs generated by your platform?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Absolutely! Our platform allows you to customize and tailor the reports and graphs according to your specific needs.
                  You can choose the desired timeframes, view performance metrics, compare different products
                  or locations, and even export the data for further analysis or presentation purposes..
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
              ...
              >
                <img
                  src="assets/images/team/anas-hamad.png"
                  alt="image"
              ...
              <div class="text-center">
                ...
                <div class="flex items-center justify-center">
                  <a
                    href="https://web.facebook.com/Anas.bassam99/" target="_blank"
                  ...
                  <a
                    href="https://twitter.com/its_anas9" target="_blank"
                    class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary"
                  >
                    <svg
                      width="18"
                  ...
                  <a
                    href="https://www.instagram.com/isthisanas/" target="_blank"
                    class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary"
                  >
                    <svg
                      width="18"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
              ...
              >
                <img
                  src="assets/images/team/abood-ellian.png"
                  alt="image"
                  class="w-full rounded-full"
                />
                <span class="absolute top-0 left-0 z-[-1]">
              ...
              <div class="text-center">
                <h4 class=" text-lg font-medium text-dark">Abdullah Ellian</h4>
                <p class="mb-5 text-sm font-medium text-body-color">
                  Computer engineering
                </p>
                <div class="flex items-center justify-center">
                  <a
                    href="https://web.facebook.com/abd.olian" target="_blank"
                    class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary"
                  >
                    <svg
                      width="10"
                  ...
                  <a
                    href="https://www.linkedin.com/in/abdullah-elian-aa8a011b6/" target="_blank"
                    class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary"
                  >
                    <svg
                      width="18"
                  ...
                  <a
                    href="https://www.instagram.com/ellian.abdallah/" target="_blank"
                    class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary"
                  >
                    <svg
                      width="18"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
              ...
              >
                <img
                  src="assets/images/team/unknown.png"
                  alt="image"
                  class="w-full rounded-full"
                />
                <span class="absolute top-0 left-0 z-[-1]">
            ...
            <div class="ud-contact-content-wrapper">
              <div class="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                <h2 class="text-[35px] font-semibold">
                  Let's talk about this more <br />
                  DataPickaxe team will love to hear from you!
                </h2>
              </div>
              <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                ...
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p class="text-base text-body-color">datapickaxe@gmail.com
                      0795874662 <br>
                      0795071904 <br>
                    </p>
                  </div>
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="mb-10 w-full">
              ...
              >
                <img
                  src="assets\images\logo\LOHO_1-removebg-preview - Copy.png"
                  alt="logo_2"
                  class="max-w-full"
                />
              </a>
              <p class="mb-7 text-base text-[#f3f4fe]">
                DataPickaxe is a B2B startup that provides technical solutions by building an aggregate model that analyzes and forecasts data to help organizations improve profitability
              </p>
              <div class="-mx-3 flex items-center">
                <a
                  href="javascript:void(0)" targer="_blank"
                ...
                <a href="https://twitter.com/datapickaxe" target="_blank" class="px-3 text-[#dddddd] hover:text-white">
                ...
                <a
                  href="https://www.instagram.com/datapickaxe/" target="_blank"
                  class="px-3 text-[#dddddd] hover:text-white"
                >
                  <svg
                    width="18"
                ...
                <a
                  href="https://www.linkedin.com/company/datapickaxe/" target="_blank"
                  class="px-3 text-[#dddddd] hover:text-white"
                >
                  <svg
                    width="18"
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div class="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a href="file:///C:/Users/Dream%204Tec/Desktop/Anas_PC/datapickaxe-main/index.html" class="inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary">
                    Home
                  </a>
                ...
                <li>
                  <a
                    href=""
                    class=" inline-block text-base leading-loose text-[#f3f4fe] hover:text-primary"
                  >
                    About
                  </a>
                </li>
